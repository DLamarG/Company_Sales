...
CREATE TABLE Customers (
	...
	CustZipCode varchar (20),
	CustAreaCode varchar (20),
...
create table Vendors (
	...
	VendName varchar (40),
	VendStreetAddress varchar (20),
	VendCity varchar (20),
	VendState varchar (20),
	VendZipCode varchar (20),
	VendPhoneNumber varchar (20),
	VendFaxNumber varchar (20),
	VendWebPage varchar (40),
...
create table Products (
	...
	CONSTRAINT fk_parent FOREIGN KEY (CategoryID) 
...
create table Orders (
	...
	constraint fk_EmplID foreign key (EmployeeID)
...
create table Order_Details (
	...
	constraint fk_ProdNum foreign key (ProductNumber)
...
create table Product_Vendors (
	...
	constraint fk_ProdNum foreign key (ProductNumber)
		references Products (ProductNumber),
	constraint fk_VenID foreign key (VendorID)
